...
import com.shiro.classflow.data.model.schedule_style.ScheduleGridStyleProto
import com.shiro.classflow.data.model.toCompose
...
class StyleSettingsRepository(
    ...
    suspend fun setCourseColorMaps(maps: List<DualColor>) {
        ...
        com.shiro.classflow.widget.updateAllWidgets(context)
    }
