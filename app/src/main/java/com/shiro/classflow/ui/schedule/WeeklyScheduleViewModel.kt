...
import com.shiro.classflow.data.repository.*
...
private data class ScheduleConfigPackage(
    val settings: com.shiro.classflow.data.db.main.AppSettings,
    val config: com.shiro.classflow.data.db.main.CourseTableConfig?,
